            ...
            <div className="col s10 offset-s1">
                <div className="saved-panel z-depth-4 center">
                    ...
                    <div className="dummy-article-panel z-depth-2">
                        <p className="dummy-headline left-align">Things are great in the world<button className="btn remove-button right"><span className="remove-button-text">Remove</span></button></p>
                        <p className="date-saved left-align">Date Saved: 11/25/15</p>
                    </div>
                    <div className="dummy-article-panel z-depth-2">
                        <p className="dummy-headline left-align">Things are great in the world but let's make a longer headline to see how it looks ok<button className="btn remove-button right"><span className="remove-button-text">Remove</span></button></p>
                        <p className="date-saved left-align">Date Saved: 11/25/15</p>
                    </div>
                    <div className="dummy-article-panel z-depth-2">
                        <p className="dummy-headline left-align">Things are great in the world<button className="btn remove-button right"><span className="remove-button-text">Remove</span></button></p>
